...
ffmpeg -hide_banner -loglevel warning -stats -n \
  ...
  -filter_complex "[0:v]setpts=PTS-STARTPTS,delogo=x=1696:y=856:w=88:h=88[a];[1:v]setpts=PTS-STARTPTS,delogo=x=1696:y=856:w=88:h=88[b];[2:v]setpts=PTS-STARTPTS,delogo=x=1696:y=856:w=88:h=88[c];[3:v]setpts=PTS-STARTPTS,delogo=x=1696:y=856:w=88:h=88[d];[a][b][c][d]concat=n=4:v=1:a=0,fps=60[frames]" \
